...
public class main {
    ...
    public static class btNhom {
        ...
        public void in() {
            System.out.print(maSV + " " + hoTen + " " + soDT + " " + soTT + " " );
        }
    }
...
//        }
        Collections.sort(listSV, new Comparator<btNhom>() {
            @Override
            public int compare(btNhom o1, btNhom o2) {
        ...
        for (btNhom nhom :listSV) {
           nhom.in();
           int o = Integer.parseInt(nhom.soTT);
           System.out.println(listBT.get(o-1));
        }
    }
}
